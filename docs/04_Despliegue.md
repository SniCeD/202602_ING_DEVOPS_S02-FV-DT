# Cuentas — Despliegue y operación
...
| API base | `/api/cuentas` |

## Docker

```bash
docker build -t duoc/jv0101-caso04-cuentas:1.0.0 .
docker run -p 8080:8080 duoc/jv0101-caso04-cuentas:1.0.0
```
