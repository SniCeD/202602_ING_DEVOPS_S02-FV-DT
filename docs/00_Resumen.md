# Cuentas — Resumen del microservicio

## Propósito

administra los datos y la lógica del dominio de Cuentas del caso caso04 (NovaBank).

## Contexto

- **Caso**: caso04 — NovaBank (Banca digital / fintech)
